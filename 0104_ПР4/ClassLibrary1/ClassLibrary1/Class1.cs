...
namespace ClassLibrary1
{
    ...
    public class Parallelogram : ConvexQuadrilateral
    {
        ...
        {
            if (!IsParallelogram())
                throw new ArgumentException("Invalid parallelogram points");
        }
        ...
        public override double GetArea()
        {
            ...
            double height = Math.Abs((B.Y - A.Y) * (C.X - B.X) - (B.X - A.X) * (C.Y - B.Y)) / baseLength;
    ...
    public class Rhombus : Parallelogram
    {
        ...
        {
            if (!IsRhombus())
                throw new ArgumentException("Invalid rhombus points");
        }
    ...
    public class Square : Rhombus
    {
        ...
        {
            if (!IsSquare())
                throw new ArgumentException("Invalid square points");
        }
