...
public class Game
{
    ...
    protected virtual void OnOutOfBounds(int x, int y)
    {
        OutOfBounds?.Invoke(this, new OutOfBoundsEventArgs(x, y));
    }
...
class Program
{
    static void Main(string[] args)
    {
        ...
        game.OutOfBounds += (sender, e) =>
        {
            ...
            Console.WriteLine($"Попытка выйти за пределы поля на координатах ({e.X}, {e.Y})");
